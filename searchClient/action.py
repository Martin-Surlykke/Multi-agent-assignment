...
class Action(Enum):
    ...
    def __init__(
        ...
        self.name_ = name
        self.type = type
        self.agent_row_delta = ard  # vertical displacement agent (-1,0,+1)
        self.agent_col_delta = acd  # horisontal displacement agent (-1,0,+1)
        self.box_row_delta = brd  # vertical displacement box (-1,0,+1)
        self.box_col_delta = bcd  # horisontal displacement box (-1,0,+1)